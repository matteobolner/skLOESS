.. skLOESS documentation master file, created by
...
**Useful links**:
`Source Repository <https://github.com/scikit-learn-contrib/skLOESS>`__ |
`Issues & Ideas <https://github.com/scikit-learn-contrib/skLOESSk/issues>`__ |

This is the documentation for the `skLOESS` to help at extending
